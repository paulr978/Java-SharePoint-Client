 ...
 * @author PRando
 */
public class GetWebCollectionResponseHandler extends BaseSharePointSoapHandler {

    private SPSite parentSite = null;

    //private Site currentSite = null;
    
    public GetWebCollectionResponseHandler(SPSite parentSite) {
    ...
    public void startElem(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if(qName.equalsIgnoreCase("Web")) {
            ...
            parentSite.addSubSite(title, url);
        }
